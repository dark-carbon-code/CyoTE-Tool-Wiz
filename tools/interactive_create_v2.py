...
def insert_tool_to_db(tool_data):
    with sqlite3.connect(DB_PATH) as conn:
        ...
        # Insert tool
        cur.execute("INSERT INTO tools (tool_name, description) VALUES (?, ?)", (tool_data["tool_name"], tool_data["description"]))
        ...
        for uc_id in tool_data["use_cases"]:
            ...
            # assumed already populated table
